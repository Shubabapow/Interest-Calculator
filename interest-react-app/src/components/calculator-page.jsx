...
import Calculations from './calculator-component';
...
function PageView() {
    ...
    function calculateInterest() {
        let interestFreq = (interestRate / 100) / compoundFrequency;
        ...
        setInvestedAmount(finalReturnValue.toLocaleString())
    ...
    return (
        <div>
            ...
            <button name="monthly-contribution" type="text" className="button" placeholder={contribution}
                   onClick={calculateInterest}>Submit</button>

            <label className="submitButton">Total Return: ${investedAmount}</label>
        </div>
    );
